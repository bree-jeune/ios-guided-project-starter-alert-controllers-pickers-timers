...
class CountdownViewController: UIViewController {
    ...
    private var duration: TimeInterval {
        // Convert from minutes and seconds to total seconds
    ...
    override func viewDidLoad() {
        ...
        // set default duration of 1 min 30 secs on the picker view
    ...
    // creates a function that uses the timer object in order to call in block parameter
    ...
    private func showAlert() {
        ...
        let alert = UIAlertController(title: "Timer Finished", message: "Your countdown is over.", preferredStyle: .alert) // Created alert controller
        let okAction = UIAlertAction(title: "Okay", style: .default, handler: nil) // Created alert controller action
